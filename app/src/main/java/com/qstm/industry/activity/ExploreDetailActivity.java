...
import com.qstm.industry.utils.ToolbarColorizeHelper;

/**
 * Created by yifeng on 16/8/10.
 *
 */
public class ExploreDetailActivity extends MainActivity {
        ...
        Palette.from(BitmapFactory.decodeResource(getResources(), res))
                .generate(new Palette.PaletteAsyncListener() {
                    ...
                    public void onGenerated(Palette palette) {
                        ...
                        ToolbarColorizeHelper.colorizeToolbar(mToolbarTb, titleTextColor, ExploreDetailActivity.this);
                    }
                });
    }
