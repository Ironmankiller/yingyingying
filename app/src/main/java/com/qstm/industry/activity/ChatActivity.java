...
import com.qstm.industry.Model.Bean.ChatInfo;
import com.qstm.industry.R;
import com.qstm.industry.Model.Bean.ChatInfo;
import com.qstm.industry.view.DropdownListView;
import com.qstm.industry.view.MyEditText;
...
public class ChatActivity extends MainActivity implements View.OnClickListener,DropdownListView.OnRefreshListenerHeader {
    private ViewPager mViewPager;
    private LinearLayout mDotsLayout;
    private MyEditText input;
    private Button send;
    private DropdownListView mListView;
    private com.qstm.industry.adapter.ChatLVAdapter mLvAdapter;
    ...
    private void initViews() {
        ...
        mLvAdapter = new com.qstm.industry.adapter.ChatLVAdapter(this, infos);
    ...
    private void InitViewPager() {
        ...
        com.qstm.industry.adapter.FaceVPAdapter mVpAdapter = new com.qstm.industry.adapter.FaceVPAdapter(views);
    ...
    private View viewPagerItem(int position) {
        ...
        com.qstm.industry.adapter.FaceGVAdapter mGvAdapter = new com.qstm.industry.adapter.FaceGVAdapter(subList, this);
    ...
    private SpannableStringBuilder getFace(String png) {
        ...
        try {
             ...
             * 格式：#[face/png/f_static_000.png]#，以方便判断当前图片为哪一个
             * */
            String tempText = "#[" + png + "]#";
            sb.append(tempText);
            sb.setSpan(
